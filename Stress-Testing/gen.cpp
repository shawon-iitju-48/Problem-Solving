...
void generate_test() {
  cout<<1<<endl;//fortestcase
  // int n = rand(1, 40); //array size
	// cout << n << '\n';
	cout << gen_array(1, 4, 500); //prothomtar por array element range.
}
...
// https://github.com/bhupixb/Stress-Testing-bash-script